...
from donation.views import donasi_saya, hapus_donasi, index, show_json, transaksi_donasi, add_donasi, add_flutter
...
urlpatterns = [
    ...
    path('add-donation-flutter/', add_flutter, name='add_flutter'),
